"""
Emotion Detector - Clean and Modular Emotion Detection System
Detects emotions from camera feed using DeepFace and OpenCV
"""
...
class EmotionDetector:
    """Clean emotion detection system with face detection and emotion analysis"""
    ...
    def detect_emotions_realtime(self, duration=10):
        ...
        while True:
            ...
            cv2.putText(processed_frame, f"Emotion Detection: {countdown}s", (10, 30), 
    ...
    def detect_emotion_single_capture(self):
        ...
        while True:
            ...
            cv2.putText(preview_frame, "Emotion Detection - Press SPACE to capture", (10, 30), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
            
            cv2.imshow('Emotion Detection - Preview', preview_frame)
            ...
            if key == ord(' '):  # Space to capture
                ...
                cv2.imshow('Emotion Detection - Result', processed_frame)
                cv2.waitKey(3000)
